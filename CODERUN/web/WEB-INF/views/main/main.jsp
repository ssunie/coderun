...
<script type="text/javascript">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
					<c:if test="${ empty sessionScope.loginMember }">
						...
						<li class="nav-item"><a class="nav-link"
							href="${ pageContext.servletContext.contextPath }/member/login">멘토
								되기</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${ pageContext.servletContext.contextPath }/member/regist">회원
								가입</a></li>
						<li class="nav-item"><a class="nav-link"
					...
					<c:if test="${ sessionScope.loginMember.type eq '회원' }">
						...
						<li class="nav-item"><a class="nav-link"
							href="/커뮤니티/게시글 목록.html">커뮤니티</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${ pageContext.servletContext.contextPath }/mentor/apply1">멘토
								되기</a></li>
						<li class="nav-item"><a class="nav-link"
	...
	<header class="masthead">
		<div class="container">
			...
			<div class="masthead-heading text-uppercase">Welcome To
				CODERUN!</div>
		</div>
	</header>
	<!-- Portfolio Grid-->
				...
				<div class="col-lg-4 col-sm-6 mb-4">
					...
					<div class="portfolio-item">
						<a class="portfolio-link" data-bs-toggle="modal"
							...
							src="${ pageContext.servletContext.contextPath }/resources/img/mentor-search.png"
							alt="..." />
						</a>
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading">멘토 소개</div>
							<div class="portfolio-caption-subheading text-muted">코드런의
								멘토진을 만나 보세요</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6 mb-4">
					...
					<div class="portfolio-item">
						<a class="portfolio-link" data-bs-toggle="modal"
							...
							src="${ pageContext.servletContext.contextPath }/resources/img/community.png"
							alt="..." />
						</a>
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading">커뮤니티</div>
							<div class="portfolio-caption-subheading text-muted">지식을 나눠
								보세요</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6 mb-4">
					...
					<div class="portfolio-item">
						<a class="portfolio-link" data-bs-toggle="modal"
							...
							src="${ pageContext.servletContext.contextPath }/resources/img/mentor-intro.png"
							alt="..." />
						</a>
						<div class="portfolio-caption">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="close-modal" data-bs-dismiss="modal">
					<img
						src="${ pageContext.servletContext.contextPath }/resources/img/close-icon.svg"
						alt="Close modal" />
				</div>
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="modal-body">
								<!-- Project details-->
								<h2 class="text-uppercase">멘토 소개</h2>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="modal-body">
								<!-- Project details-->
								<h2 class="text-uppercase">멘토 되기</h2>
								<br> <img class="img-fluid d-block mx-auto"
									src="${ pageContext.servletContext.contextPath }/resources/img/mentor-intro.png"
									alt="..." />
